...
import io.lee.rpcfx.netty.NettyClientImpl;
...
//            RpcfxResponse response = post(request, url);
            //实现netty client
            RpcfxResponse response = new NettyClientImpl().post(request, url);
            ...
            System.out.println(JSON.parse(response.getResult().toString()));
